...
const Myclasscard = props => {
  ...
  const downloadHandler = (subject, div) => {
    ...
    downloadCall(
      `https://wizdem.pythonanywhere.com/Attendance/get_csv/${selectedSubject}/${selectedDiv}/${formatdDatestart}/${formatdDateend}`
    );
  };
            ...
            <Card className={classes.card}>
              ...
              <CardActions disableActionSpacing style={{}}>
                <Button
                  ...
                  onClick={handleClickDownload.bind(this, subject)}
                >
                  Download
                ...
                <Button
                  ...
                  color="primary"
                  className={classes.button}
                  onClick={handleOpen.bind(this, subject)}
                >
                  View
                ...
                <Link
                  to={{
                    pathname: `/editTable/${subject.div}`,
                    state: subject
                  }}
                  style={{ textDecoration: "none" }}
                >
